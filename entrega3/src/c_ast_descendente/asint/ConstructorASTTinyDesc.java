...
public class ConstructorASTTinyDesc implements ConstructorASTTinyDescConstants {
  ...
  final public ProgT programa_tiny() throws ParseException {
    ...
    try {
         Blq blq;
      blq = bloque();
                         {if (true) return sem.prog_tiny(blq);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Blq bloque() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(FINBLOQUE);
                         {if (true) return sem.bloque(l_opt_decs, l_opt_inst);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("bloque");
    }
    ...
    try {
      ...
      case Identificador:
        ...
        jj_consume_token(FINDECLARACIONES);
                         {if (true) return sem.si_lista_opt_decs(l_decs);}
        break;
      default:
        jj_la1[0] = jj_gen;
                         {if (true) return sem.no_lista_opt_decs();}
      }
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Dec declaracion_variable() throws ParseException {
    ...
    try {
      ...
      t = jj_consume_token(Identificador);
                         {if (true) return (Dec)sem.dec_var(tipo, t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Dec declaracion_tipo() throws ParseException {
    ...
    try {
      ...
      tipo = tipo();
      t = jj_consume_token(Identificador);
                         {if (true) return (Dec)sem.dec_tipo(tipo, t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Dec declaracion_proc() throws ParseException {
    ...
    try {
      ...
      bloque = bloque();
                         {if (true) return (Dec)sem.dec_proc(t.image, l_opt_param_form, bloque).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
    ...
    try {
      ...
      case Identificador:
        l_param_form = lista_parametros_formales();
                         {if (true) return sem.si_lista_opt_param_form(l_param_form);}
        break;
      default:
        jj_la1[3] = jj_gen;
                         {if (true) return sem.no_lista_opt_param_form();}
      }
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public ParamForm RECpf(Tipo th) throws ParseException {
    ...
    try {
      ...
      case REFERENCIA:
        ...
        t = jj_consume_token(Identificador);
                         {if (true) return (ParamForm) sem.param_form_ref(th, t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      case Identificador:
        t = jj_consume_token(Identificador);
                         {if (true) return (ParamForm) sem.param_form(th, t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      default:
        jj_la1[5] = jj_gen;
        jj_consume_token(-1);
    ...
    try {
      ...
      case INT:
        jj_consume_token(INT);
                         {if (true) return sem.int_t();}
        break;
      case REAL:
        jj_consume_token(REAL);
                         {if (true) return sem.real_t();}
        break;
      case BOOL:
        jj_consume_token(BOOL);
                         {if (true) return sem.bool_t();}
        break;
      case STRING:
        jj_consume_token(STRING);
                         {if (true) return sem.string_t();}
        break;
      default:
        jj_la1[9] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Tipo tipo_registro() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(FINBLOQUE);
                         {if (true) return sem.tipo_registro(l_param_reg);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Tipo tipo_definido() throws ParseException {
    ...
    try {
         Token t;
      t = jj_consume_token(Identificador);
                         {if (true) return (Tipo) sem.tipo_definido(t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public ParamReg parametro_registro() throws ParseException {
    ...
    try {
      ...
      tipo = tipo();
      t = jj_consume_token(Identificador);
                         {if (true) return (ParamReg) sem.param_reg(tipo, t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
    ...
    try {
      ...
      case ARROBA:
        l_inst = lista_instrucciones();
                         {if (true) return sem.si_lista_opt_inst(l_inst);}
        break;
      default:
        jj_la1[11] = jj_gen;
                         {if (true) return sem.no_lista_opt_inst();}
      }
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_eval() throws ParseException {
    ...
    try {
      ...
      exp = expresion();
                         {if (true) return sem.inst_eval(exp);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Exp FE0(Exp eh) throws ParseException {
    ...
    try {
      ...
      case ASIGNACION:
        ...
        e = E0();
                         {if (true) return (Exp) sem.asignacion(eh, e).ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      default:
        jj_la1[14] = jj_gen;
                         {if (true) return eh;}
    ...
    try {
      ...
      case MAS:
        ...
        e2 = RE2(sem.suma(eh, e1));
                         {if (true) return (Exp) e2.ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      default:
        jj_la1[16] = jj_gen;
                         {if (true) return eh;}
  ...
  final public Exp FE2(Exp eh) throws ParseException {
    ...
    try {
      ...
      case MENOS:
        ...
        e = E3();
                         {if (true) return (Exp) sem.resta(eh, e).ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      default:
        jj_la1[17] = jj_gen;
                         {if (true) return eh;}
    ...
    try {
      ...
      case Cadena:
        t = jj_consume_token(Cadena);
                         {if (true) return (Exp)sem.cadena(t.image).ponFila(t.beginLine).ponCol(t.beginColumn);}
        break;
      case Identificador:
        t = jj_consume_token(Identificador);
  ...
  final public Inst instruccion_if_else() throws ParseException {
    ...
    try {
      ...
      b1 = bloque();
      b2 = then_else();
                         {if (true) return sem.inst_if_else(e, b1, b2);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Blq then_else() throws ParseException {
    ...
    try {
      ...
      case ELSE:
        ...
        blq = bloque();
                         {if (true) return sem.si_else(blq);}
        break;
      default:
        jj_la1[26] = jj_gen;
                         {if (true) return sem.no_else();}
      }
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_while() throws ParseException {
    ...
    try {
      ...
      e = expresion();
      bloque = bloque();
                         {if (true) return sem.inst_while(e, bloque);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_read() throws ParseException {
    ...
    try {
      ...
      e = expresion();
                         {if (true) return sem.inst_read(e);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_write() throws ParseException {
    ...
    try {
      ...
      e = expresion();
                         {if (true) return sem.inst_write(e);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_delete() throws ParseException {
    ...
    try {
      ...
      e = expresion();
                         {if (true) return sem.inst_delete(e);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Inst instruccion_call() throws ParseException {
    ...
    try {
      ...
      l_opt_param = parametros();
                         {if (true) return (Inst) sem.inst_call(t.image, l_opt_param).ponFila(t.beginLine).ponCol(t.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
    ...
    try {
      ...
      case Cadena:
        l_param = lista_parametros();
                         {if (true) return sem.si_lista_opt_param(l_param);}
        break;
      default:
        jj_la1[27] = jj_gen;
                         {if (true) return sem.no_lista_opt_param();}
      }
    throw new Error("Missing return statement in function");
    } finally {
