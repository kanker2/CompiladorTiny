...
Token t;
      ...
      case REFERENCIA:{
        ...
        t = jj_consume_token(Identificador);
{if ("" != null) return sem.param_form_ref(th, t.image);}
        break;
        }
      case Identificador:{
        t = jj_consume_token(Identificador);
{if ("" != null) return sem.param_form(th, t.image);}
        break;
        }
      default:
        jj_la1[5] = jj_gen;
...
Token t;
      t = jj_consume_token(Identificador);
{if ("" != null) return sem.tipo_definido(t.image);}
    throw new Error("Missing return statement in function");
    } finally {
...
Tipo tipo; Token t;
      tipo = tipo();
      t = jj_consume_token(Identificador);
{if ("" != null) return sem.param_reg(tipo, t.image);}
    throw new Error("Missing return statement in function");
    } finally {
...
Exp e;
      ...
      case AND:{
        ...
        e = E3();
{if ("" != null) return sem.and(eh, e);}
        break;
        }
      case OR:{
        jj_consume_token(OR);
        e = E4();
{if ("" != null) return sem.or(eh, e);}
        break;
        }
      default:
        jj_la1[18] = jj_gen;
...
{if ("" != null) return sem.true_e();}
        break;
        }
      case FALSE:{
        jj_consume_token(FALSE);
{if ("" != null) return sem.false_e();}
        break;
        }
      case NULL:{
        jj_consume_token(NULL);
{if ("" != null) return sem.null_e();}
        break;
        }
      case Cadena:{
...
{if ("" != null) return sem.inst_call(t.image, l_opt_param);}
    throw new Error("Missing return statement in function");
    } finally {
